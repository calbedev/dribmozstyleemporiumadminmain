...
export function OrderDetail({ orderId }: OrderDetailProps) {
  ...
  const order = useQuery(api.adminstoreOrders.getById, { id: orderId as any })
  const updateStatus = useMutation(api.adminstoreOrders.updateStatus)
  const updatePaymentStatus = useMutation(api.adminstoreOrders.updatePaymentStatus)
